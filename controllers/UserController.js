class UserController{
    ...
    onEdit(){
        ...
        document.querySelector('#box-user-update .btn-cancel').addEventListener('click', e=> {
            ...
            Utils.showAndHideForm('#box-user-create', '#box-user-update')
        })
    ...
    onSubmit(){
        ...
        this.formCreateEl.addEventListener('submit', event => {
            ...
            // this.insert(values) -> Insere no datset
    ...
    getPhoto(formCreateEl){
        ...
        return new Promise((resolve, reject) => {
            ...
            file ? fileReader.readAsDataURL(file) : resolve('dist/img/user.jpg')
    ...
    getValues(formCreateEl){
        ...
        //Spread usado para pegar elemwntos que não seja, de array

          ;[...formCreateEl.elements].forEach((field, index) => {
   ...
   /* insert(data){
    ...
    addEventsTr(tr){
        ...
        tr.querySelector('.btn-edit').addEventListener('click', e=>{
            ...
            Utils.showAndHideForm('#box-user-update', '#box-user-create')
        })
    ...
    updateCount(){
        ...
        let numberUsers = 0, numberAdmins = 0
        ...
        ;[...this.tableEl.children].forEach(tr=>{
            ...
            user._admin ? numberAdmins++ : false
